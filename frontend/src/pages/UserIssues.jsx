    ...
    <div className="flex flex-col gap-6">
      <header className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          ...
          <p className="text-text-muted">Ask for advice when your electricity usage feels unusually high.</p>
        </div>
      ...
      {loading ? (
        <div className="text-center py-10 text-text-muted">Loading issues...</div>
      ) : items.length === 0 ? (
        <div className="text-center py-10 text-text-muted">No issues yet. Create one to get advice.</div>
      ) : (

...
const ProductManagement = () => {
  ...
  const fetchProducts = async () => {
    setLoading(true);
    try {
      const res = await api.get(API_ENDPOINTS.PRODUCTS.ADMIN);
    ...
    <div className="flex flex-col gap-5">
      ...
      <header className="flex flex-col md:flex-row md:justify-between md:items-start gap-4">
        <div>
          ...
          <p className="text-xs md:text-sm text-gray-400 mt-0.5">View, edit and manage all marketplace listings.</p>
        </div>
